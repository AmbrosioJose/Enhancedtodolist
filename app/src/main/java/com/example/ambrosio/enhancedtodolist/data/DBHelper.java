...
import com.example.ambrosio.enhancedtodolist.ToDoListAdapter;
...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        String queryString = "CREATE TABLE " + Contract.TABLE_TODO.TABLE_NAME + " ("+
                ...
                Contract.TABLE_TODO.COLUMN_NAME_PRIORITY + " TEXT NOT NULL, " +
                Contract.TABLE_TODO.COLUMN_NAME_IS_DONE + " TEXT NOT NULL, " +
